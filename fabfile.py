"""
Starter fabfile for deploying the r300 project.
...
# CHANGEME
env.hosts = ['user@r300.example.com']
env.code_dir = '/srv/www/r300'
env.project_dir = '/srv/www/r300/r300'
env.static_root = '/srv/www/r300/static/'
env.virtualenv = '/srv/www/r300/.virtualenv'
env.code_repo = 'git@github.com:user/r300.git'
env.django_settings_module = 'r300.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/r300/wsgi.py" % env.code_dir)
